...
st.header("⏱️ 用餐高峰时段")
data = pd.DataFrame({
    '时段': ['11.0', '11.5', '12.0', '12.5', '13.0','13.5','14.0','14.5','15.0','15.5','16.0','16.5','17.0'],
    '九京客北京烤鸭':[86, 92, 81, 86, 78, 70, 75, 86, 60, 70, 75, 60, 66],
    '意式风味牛排饭':[83, 90, 80, 84, 76, 66, 70, 80 ,67, 58, 63, 70, 60],
    '意面叔叔':[88, 94, 90, 80, 87, 77, 68, 71, 60, 70, 75, 60, 65],
    '窑鸡王':[90, 95, 80, 78, 75, 76, 80, 70, 60, 74, 75, 69, 55],
    '港味记滑蛋饭茶餐厅':[76, 79, 84, 72, 68, 66, 75, 50, 60, 70, 75, 63, 57],
})
# 根据上面创建的data，创建数据框
df = pd.DataFrame(data)
st.area_chart(df,x='时段',y=['九京客北京烤鸭','意式风味牛排饭','意面叔叔','窑鸡王','港味记滑蛋饭茶餐厅'])
